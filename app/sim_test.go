...
func TestFullAppSimulation(t *testing.T) {
	...
	app := New(
		...
		DefaultNodeHome, simapp.FlagPeriodValue, MakeEncodingConfig(), simapp.EmptyAppOptions{}, fauxMerkleModeOpt,
	)
...
func TestAppImportExport(t *testing.T) {
	...
	app := New(
		...
		simapp.FlagPeriodValue, MakeEncodingConfig(), simapp.EmptyAppOptions{}, fauxMerkleModeOpt,
	)
	require.Equal(t, Name, app.Name())
	...
	storeKeysPrefixes := []StoreKeysPrefixes{
		...
		// Custom modules
		{app.keys[wtatypes.StoreKey], newApp.keys[wtatypes.StoreKey], [][]byte{}},
	}
...
func TestAppStateDeterminism(t *testing.T) {
	...
	for i := 0; i < numSeeds; i++ {
		...
		for j := 0; j < numTimesToRunPerSeed; j++ {
			...
			app := New(
				logger, db, nil, true, map[int64]bool{}, DefaultNodeHome,
				simapp.FlagPeriodValue, MakeEncodingConfig(), simapp.EmptyAppOptions{}, interBlockCacheOpt(),
			)
